...
<p align="center">
  <strong>AI Product Manager & Builder</strong> · Accenture · Argentina<br/>
...
| | Project | Description |
|-|---------|-------------|
| 🤖 | **Product Inventory Comparison Agent** | Agentic AI for portfolio analytics & data management at Accenture |
| 🍽️ | **Dietary Safety Agent** *(MBT thesis)* | Analyzes menus against user dietary profiles — fast, safe, guided food decisions |
